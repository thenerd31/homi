"""
New Search Routes - Using Claude CSV Search

These routes use Claude to parse and match listings from CSV files
"""
...
@router.get("/api/listing/{listing_id}")
