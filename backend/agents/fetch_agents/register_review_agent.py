"""
Register VIBE Review Agent (RedFlagRick) on Agentverse
"""
import os
...
os.environ["AGENT_SEED_PHRASE"] = "vibe_review_secret_phrase"

# Register the agent
register_chat_agent(
    "review agent",
    "http://localhost:8104/submit",
    active=True,
...
print("✅ Review Agent (RedFlagRick) registered successfully!")
