"""
Register VIBE Local Guide Agent (LocalLegend) on Agentverse
"""
import os
...
os.environ["AGENT_SEED_PHRASE"] = "vibe_local_guide_secret_phrase"

# Register the agent
register_chat_agent(
    "local guide agent",
    "http://localhost:8105/submit",
    active=True,
...
print("✅ Local Guide Agent (LocalLegend) registered successfully!")
