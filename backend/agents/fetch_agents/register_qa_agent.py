"""
Register VIBE Q&A Agent (VibeHost) on Agentverse
"""
import os
...
os.environ["AGENT_SEED_PHRASE"] = "vibe_qa_secret_phrase"

# Register the agent
register_chat_agent(
    "qa agent",
    "http://localhost:8103/submit",
    active=True,
...
print("✅ QA Agent (VibeHost) registered successfully!")
